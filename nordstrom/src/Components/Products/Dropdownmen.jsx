...
const Categories=[{name:'Jeans'},{name:'Jackets'},{name:'shirts'},{name:'Loungewear'},{name:'sweaters'}];
...
const Brands=[{name:"Polo"},{name:"Adidas"},{name:"Topman"},{name:"Nordstrom"},{name:"Mavi Jeans"},{name:"Nike"},
